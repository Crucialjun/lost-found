			...
			<div className="container mx-auto px-4">
				<div className="max-w-2xl mx-auto">
					...
					<div className="text-center mb-8">
						...
						<p className="text-gray-600 text-lg">Help us help you find your lost item</p>
					</div>
						...
						<form onSubmit={handleSubmit} className="space-y-6">
							...
							<div className="space-y-6">
								...
								<div>
									...
									<textarea
										...
										className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200 bg-white resize-vertical"
									/>
								</div>
							...
							<div className="space-y-6">
								...
								<div>
									...
									<input
										...
										onChange={handleInputChange}
										placeholder="e.g., $50, Coffee gift card..."
										className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200 bg-white"
									/>
							...
							<div className="pt-6">
								<button
									type="submit"
									disabled={loading}
									className="w-full bg-gradient-to-r from-red-600 to-pink-600 text-white py-4 px-6 rounded-lg hover:from-red-700 hover:to-pink-700 transition-all duration-200 transform hover:scale-105 font-semibold text-lg shadow-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
								>
									{loading ? (
					...
					<div className="mt-8 bg-red-50 border border-red-200 rounded-lg p-6">
						<h3 className="text-lg font-semibold text-red-800 mb-3">💡 Tips for Better Results</h3>
						<ul className="text-red-700 space-y-2 text-sm">
							<li>• Be as specific as possible in your description</li>
							<li>• Include unique identifying features or markings</li>
							<li>• Mention the exact location and time when possible</li>
							<li>• Consider offering a reward to motivate finders</li>
